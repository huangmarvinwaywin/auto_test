...
class Test(unittest.TestCase):
    ...
    def setUpClass(self):
        ...
        self.URL = "https://storage.googleapis.com/ww-cocos/index.html"
...
basedir = "D:/Selenium/auto_test/"
if __name__ == '__main__':
    test_suite = unittest.defaultTestLoader.discover(basedir, pattern='*.py')
    result = BeautifulReport(test_suite)
    result.report(filename='report',description='我的第一個測試', log_path='D:/Selenium/auto_test/')
